            ...
            <div class="row">
                <div class="col-12">
                    <div class="error_form">
                        <?php if(isset($_GET['pesan'])){ if($_GET['pesan'] == "berhasildaftar"){ ?>
                        <h2 class="sub-title">Registrasi Berhasil!</h2>
                        <p>Anda telah berhasil melakukan registrasi, silahkan pilih halaman yang anda inginkan</p>
                        <a href="login-pelanggan.php" class="btn btn-primary btn-hover-dark rounded-0">Masuk</a>
                        <a href="index.php" class="btn btn-secondary btn-hover-dark rounded-0">Home</a>
                        <?php }else{ ?>
                        <h2 class="sub-title">Registrasi Gagal!</h2>
