...
<?php 
    ...
    $sql = $koneksi->query("select * from kategori where id_kategori='$kategori'");
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-6">
                    <div class="banner" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="product-list-title">
                            <h2 class="title pb-3 mb-0">Produk berdasarkan kategori <?php echo $tampil['nama_kategori'] ?></h2>
                            <span></span>
                        </div>
                        <!-- Product List Carousel Start -->
                                                <div style="display: flex; flex-direction: row; flex-wrap: wrap; column-gap: 20px; grid-row-gap: 20px;">
                            <?php
                            $produk = mysqli_query($koneksi,"SELECT * FROM produk WHERE kategori_produk='$_GET[kategori]'");
